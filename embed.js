!function( e, t, s ){
	...
	if( o.extend = function( e, t ){
			...
			for( var i = [
				...
				"Webkit",
				"ms"
			], e = e.charAt( 0 ).toUpperCase() + e.substr( 1 ), r = 0; r < i.length; r++ )if( "string" == typeof a[ i[ r ] + e ] )return s ? i[ r ] + e : !0
		}, !e.DUOSHUO ){
		...
		var Z = {
			...
			// },
			avatarUrl : function( e ){
				return (e.avatar_url && e.avatar_url.indexOf('cdncache.org') == -1) ? e.avatar_url : 'https://avatar.duoshuo.com/avatar-50/941/286045.jpg' || rt.data.default_avatar_url
			},
					...
					function t(){
						...
						try{
							if( a.hasClass( "ds-comment-context" ) ){
								K.attr( "id", "ds-ctx-bubble" ).attr( "data-post-id", a.attr( "data-post-id" ) ).html( '<ul id="ds-ctx">' + et.ctxPost( { post : lt[ a.attr( "data-parent-id" ) ].toJSON() } ) + '</ul><div class="ds-bubble-footer"><a class="ds-ctx-open" href="javascript:void(0);">查看对话</a></div>' );
			...
			X.mouseenter( N ).mouseleave( I ), st.PostList = function( e ){
				...
				updateCounter : function( e ){
					...
					var s = {
						duoshuo : [
							"comments",
							t( z.comments_multiple ) || "评论"
						],
						repost : [
							"reposts",
							t( z.reposts_multiple ) || "转载"
						],
						weibo : [
							"weibo_reposts",
							t( z.weibo_reposts_multiple ) || "新浪微博"
						],
						qqt : [
							"qqt_reposts",
							t( z.qqt_reposts_multiple ) || "腾讯微博"
						]
					};
				...
				render : function(){
					var e = this.el;
					e.attr( "id", "ds-login" ).html( et.loginWidget( [
						"weixin",
						"weibo",
						"qq",
						"renren",
						"kaixin",
						"douban"
					] ) ), e.find( "a" ).click( l ), e.find( "a.ds-logout" ).attr( "href", Z.logoutUrl() )
				}
